...
export function getDesktopPrepareTrainingDatasetChannel(kind:"start-request"|"start-response"|"task-read-request"|"task-read-response"): IpcChannel<any,any,IpcChannelValue<any,any>>{ switch(kind){case "start-request": return DESKTOP_DATASET_PREPARE_TRAINING_START_REQUEST_CHANNEL; case "start-response": return DESKTOP_DATASET_PREPARE_TRAINING_START_RESPONSE_CHANNEL; case "task-read-request": return DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_REQUEST_CHANNEL; default: return DESKTOP_DATASET_PREPARE_TRAINING_TASK_READ_RESPONSE_CHANNEL;} }
