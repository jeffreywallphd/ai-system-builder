...
import type { CancelRuntimeTaskResult, RuntimeTaskStatusRecord, StartRuntimeTaskResult } from "../runtime";
...
export type DesktopImageGenerationReadResponse = IpcResponse<RuntimeTaskStatusRecord, Record<string, unknown>, typeof DESKTOP_IMAGE_GENERATION_READ_OPERATION, Record<string, never>, typeof DESKTOP_IMAGE_GENERATION_READ_RESPONSE_CHANNEL.value>;
