...
import { normalizeEffectiveAssetProjectionRefreshReason, type CreateEffectiveAssetProjectionCommand, type InvalidateEffectiveAssetProjectionCommand, type ListEffectiveAssetProjectionsCommand, type ReadEffectiveAssetProjectionCommand, type RefreshEffectiveAssetProjectionCommand, type ValidateEffectiveAssetProjectionReadinessCommand } from "./effective-asset-projection-commands";
...
export const normalizeRefreshEffectiveAssetProjectionCommand = (value: RefreshEffectiveAssetProjectionCommand): RefreshEffectiveAssetProjectionCommand => ({ ...value, targetWorkspaceId: createWorkspaceId(value.targetWorkspaceId), projectionId: normalizeEffectiveAssetProjectionId(value.projectionId), reason: normalizeEffectiveAssetProjectionRefreshReason(value.reason) });
export const normalizeInvalidateEffectiveAssetProjectionCommand = (value: InvalidateEffectiveAssetProjectionCommand): InvalidateEffectiveAssetProjectionCommand => ({ ...value, targetWorkspaceId: createWorkspaceId(value.targetWorkspaceId), projectionId: normalizeEffectiveAssetProjectionId(value.projectionId), reason: normalizeEffectiveAssetProjectionRefreshReason(value.reason) });
