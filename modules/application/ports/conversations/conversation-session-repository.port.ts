...
export interface ConversationSessionRepositoryPort {
  ...
  getConversationSessionById(workspaceId: string, sessionId: ConversationSessionId): Promise<ConversationSessionRecord | undefined>;
