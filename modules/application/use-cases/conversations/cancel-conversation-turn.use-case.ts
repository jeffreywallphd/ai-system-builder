...
export class CancelConversationTurnUseCase {
  public constructor(private readonly d: { turnRepository: ConversationTurnRepositoryPort; executionRunRepository: ExecutionRunRepositoryPort }) {}
  public async execute(command: CancelConversationTurnCommand): Promise<CancelConversationTurnResult> {
    ...
    return { kind: 'success', value: { status: 'not-supported' } };
  }
}
