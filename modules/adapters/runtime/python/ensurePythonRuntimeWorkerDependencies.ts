...
const WORKER_DEPENDENCY_PROBE_SCRIPT = "import fastapi, uvicorn, huggingface_hub, hf_xet, transformers";
...
function installWorkerRequirementsIfNeeded(
  ...
  const missingDependencyPattern = /No module named ['"](fastapi|uvicorn|huggingface_hub|hf_xet|transformers)['"]/i;
