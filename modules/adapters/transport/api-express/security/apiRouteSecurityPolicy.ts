...
export const API_ROUTE_POLICIES: ReadonlyMap<string, ApiRoutePolicy> = new Map<string, ApiRoutePolicy>([
  ...
  ["GET /api/asset-implementations/releases", { public: false, scopes: ["asset:read"] }],
  ["POST /api/asset-implementations/resolve", { public: false, scopes: ["asset:read"] }],
  ["GET /api/asset-packages", { public: false, scopes: ["asset:read"] }],
  ["POST /api/asset-packages/inspect", { public: false, scopes: ["asset:write"] }],
  ["POST /api/asset-packages/admit", { public: false, scopes: ["asset:write"] }],
  ["POST /api/asset-packages/activate", { public: false, scopes: ["asset:write"] }],
  ["POST /api/asset-packages/disable", { public: false, scopes: ["asset:write"] }],
  ["POST /api/asset-packages/rollback", { public: false, scopes: ["asset:write"] }],
  ["GET /api/asset-studio/workflows", { public: false, scopes: ["asset:read"] }],
  ["GET /api/asset-studio/proposal", { public: false, scopes: ["asset:read"] }],
  ["POST /api/asset-studio/start", { public: false, scopes: ["asset:write"] }],
  ["POST /api/asset-studio/propose", { public: false, scopes: ["asset:write"] }],
  ...
  ["POST /api/systems/create-from-template", { public: false, scopes: ["asset:write"] }],
  ...
  ["POST /api/systems/revisions/save", { public: false, scopes: ["asset:write"] }],
  ["POST /api/systems/builds/request", { public: false, scopes: ["asset:write"] }],
  ["POST /api/systems/builds/cancel", { public: false, scopes: ["asset:write"] }],
  ["GET /api/systems/build", { public: false, scopes: ["asset:read"] }],
  ["GET /api/systems/builds", { public: false, scopes: ["asset:read"] }],
  ["POST /api/systems/releases/approve", { public: false, scopes: ["asset:write"] }],
  ["GET /api/systems/release", { public: false, scopes: ["asset:read"] }],
  ["GET /api/systems/releases", { public: false, scopes: ["asset:read"] }],
  ["GET /api/systems/releases/compare", { public: false, scopes: ["asset:read"] }],
  ["GET /api/systems/data/form", { public: false, scopes: ["asset:read"] }],
  ["POST /api/systems/data/records/create", { public: false, scopes: ["asset:write"] }],
  ["GET /api/systems/data/record", { public: false, scopes: ["asset:read"] }],
  ["POST /api/systems/data/records/update", { public: false, scopes: ["asset:write"] }],
