...
export function useImageGenerationFeature(client?: DesktopImageGenerationClient, modelsClient?: DesktopModelsClient, artifactClient?: DesktopArtifactBrowserClient, workspaceId?: string) {
  ...
  return { form, setForm, status, requestId, message, error, progress, taskData, outputs, finalizedAssets, validationError, isStartDisabled, start, cancel, repairInstall, installStatus, availableModels, availableImageArtifacts, artifactLoadMessage, modelLoadStatus, modelLoadMessage };
}
