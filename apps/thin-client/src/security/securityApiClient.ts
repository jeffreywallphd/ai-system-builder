...
export interface SecurityStatusResult { mode: "disabled-dev" | "lan-https-token"; httpsEnabled: boolean; httpsRequired: boolean; authRequired: boolean; pairingEnabled: boolean; pairedDeviceCount?: number; currentPrincipal?: { displayName?: string; deviceName?: string; deviceId?: string }; devSecurityToggleEnabled?: boolean; devSecurityEnforcementMode?: "disabled-dev" | "lan-token-enforced"; requiresRestartToChangeTransportSecurity?: boolean; tls?: { mode?: "manual" | "auto-self-signed" | "auto-local-ca"; source?: "manual" | "generated" | "reused" | "not-required"; certificateDirectory?: string; certificatePath?: string; hosts?: readonly string[]; expiresAt?: string } }
