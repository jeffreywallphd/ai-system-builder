...
export function AppShell({ activePage, onNavigate, pages, children }: AppShellProps) {
  ...
  const primaryPages = pages.filter((page) => page.key !== "settings" && page.key !== "home");
  const navigationPages: readonly (ThinClientPageDefinition | { readonly key: "home"; readonly label: "Home" })[] = [
    { key: "home", label: "Home" },
    ...primaryPages,
  ];
