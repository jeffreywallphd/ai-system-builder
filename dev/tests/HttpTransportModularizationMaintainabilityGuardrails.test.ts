...
const moduleOwnershipFiles = Object.freeze([
  ...
  "route-families/IdentityAndTrustedDeviceRouteFamilyHandler.ts",
  "route-families/WorkspaceRouteFamilyHandler.ts",
  "route-families/AuthorizationRouteFamilyHandler.ts",
