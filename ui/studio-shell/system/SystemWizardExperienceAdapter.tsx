...
const definition: WizardExperienceAssetDefinition<SystemWizardExperienceContext> = Object.freeze({
  ...
  resolveProgress: ({ context, activePageId }) => {
    ...
    return Object.freeze({
      ...
      readyCount,
      focusLabel: pages.find((page) => page.id === activePageId)?.title ?? "Compose",
    });
  },
  resolveReadiness: (context) => Object.freeze({
    title: "System setup readiness",
    description: context.document.systemSpec.components.length > 0
      ? "Your main composition is in place. Add interfaces and settings to make this system reusable."
      : "Start by adding at least one component to your system.",
