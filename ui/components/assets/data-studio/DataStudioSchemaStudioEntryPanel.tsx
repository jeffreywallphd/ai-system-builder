  ...
  return (
    <section className="ui-card ui-card--padded ui-stack ui-stack--sm" data-testid="data-studio-schema-entry-panel">
      <header className="ui-stack ui-stack--2xs">
        <strong>Data structure workspace</strong>
        <p className="ui-subtle">
          Use Schema Studio to design tables and fields. Keep this Data Studio focused on ingestion, mapping, cleanup,
      ...
      {!isLoading && !loadError && schemas.length === 0 ? (
        <div className="ui-subtle">No schema assets found yet. Create one to define your data structure.</div>
      ) : null}
