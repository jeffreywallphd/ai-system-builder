...
type SyncBridgeGroup = Record<string, SyncBridgeMethod>;
type AsyncBridgeGroup = Record<string, AsyncBridgeMethod>;
...
function guardDeferredAsyncGroup<TGroup extends AsyncBridgeGroup>(
  groupName: string,
  group: TGroup,
): TGroup {
  const entries = Object.entries(group).map(([methodName, method]) => {
...
const connectivityBridge = Object.freeze({
...
const workflowsBridge = Object.freeze({
...
const executionRunsBridge = Object.freeze({
...
const workflowRunSummariesBridge = Object.freeze({
...
const modelFilesBridge = Object.freeze({
...
const canonicalAssetsBridge = Object.freeze({
...
const studioShellBridge = Object.freeze({
...
const registryBridge = Object.freeze({
...
const agentsBridge = Object.freeze({
