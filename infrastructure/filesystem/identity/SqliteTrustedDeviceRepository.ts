...
export class SqliteTrustedDeviceRepository implements ITrustedDeviceRepository, ITrustedDevicePairingRepository {
  ...
  private initialize(database: SqliteCompatDatabase): void {
    ...
    for (const [version, migrationSql] of IDENTITY_MIGRATIONS) {
      ...
      database.transaction(() => {
        ...
        database.prepare("INSERT INTO identity_repository_migrations (version, applied_at) VALUES (?, ?)")
