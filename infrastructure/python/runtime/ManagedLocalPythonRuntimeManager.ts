...
export interface ManagedLocalPythonRuntimeManagerOptions {
...
export class ManagedLocalPythonRuntimeManager implements IPythonRuntimeManager {
  private readonly adapter: ManagedServicePythonRuntimeManagerAdapter;

  constructor(options: ManagedLocalPythonRuntimeManagerOptions) {
