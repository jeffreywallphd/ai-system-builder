...
export const LANGCHAIN_NODE_REGISTRATIONS: ReadonlyArray<ILangChainNodeRegistrationDescriptor> =
  Object.freeze([
    ...
    { nodeTypeId: "langchain.output_parser", executionStyles: DEFAULT_EXECUTION_STYLES, category: "LangChain" },
    { nodeTypeId: "langchain.memory", executionStyles: DEFAULT_EXECUTION_STYLES, category: "LangChain" },
    ...
    { nodeTypeId: "langchain.tool_definition", executionStyles: DEFAULT_EXECUTION_STYLES, category: "LangChain" },
