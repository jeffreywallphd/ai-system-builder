---
title: "AI Companion: Desktop Control-Plane Host Promotion Baseline (Story 1.1.1)"
doc_type: baseline
status: active
...
# AI Companion: Desktop Control-Plane Host Promotion Baseline (Story 1.1.1)
...
Current canonical guidance: `docs/architecture/domains/runtime-host-surfaces/overview.ai.md` and `docs/architecture/domains/runtime-host-surfaces/references/host-composition-root-contracts.ai.md`  
