...
| 002 | accepted | 2026-04-11 | Workspace-Centered Tenancy and Resource Ownership | `docs/adr/records/adr-002-workspace-centered-tenancy-and-resource-ownership.md` |
| 003 | accepted | 2026-04-11 | Storage as Managed Platform Resource | `docs/adr/records/adr-003-storage-as-managed-platform-resource.md` |
| 004 | accepted | 2026-04-11 | Studios as Views Over Shared System and Asset Model | `docs/adr/records/adr-004-studios-as-views-over-shared-system-and-asset-model.md` |
| 005 | accepted | 2026-04-11 | Trust, Identity, and Security Boundary Enforcement | `docs/adr/records/adr-005-trust-identity-and-security-boundary-enforcement.md` |
| 006 | accepted | 2026-04-11 | Policy-Aware Scheduling and Controlled Execution | `docs/adr/records/adr-006-policy-aware-scheduling-and-controlled-execution.md` |
