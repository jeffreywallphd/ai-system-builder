...
- Apply canonical metadata fields: [Documentation Taxonomy](./context/documentation-taxonomy.ai.md), [Documentation Segmentation Taxonomy](./context/documentation-segmentation-taxonomy.ai.md), [Documentation Segmentation Seed Guidance](./context/documentation-segmentation-seed-guidance.ai.md), [Documentation Status Signals](./context/documentation-status-signals.ai.md), [Supersession and Redirect Conventions](./context/documentation-supersession-and-redirect-conventions.ai.md), and [Metadata Header Contract](./context/documentation-metadata-header.ai.md).
