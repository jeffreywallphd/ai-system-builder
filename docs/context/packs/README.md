...
- Prefer ADR citations in foundational or high-risk packs where decision history materially constrains outcomes.
- Keep ADR lists selective (typically one to three links) to avoid routing noise.
...
- [Seed Pack: Startup and Host Promotion](./startup-and-host-promotion.pack.md)
- [Seed Pack: Transport and Runtime Availability](./transport-and-runtime-availability.pack.md)
- [Seed Pack: Observability and Readiness](./observability-and-readiness.pack.md)
- [Seed Pack: Storage, Persistence, and Materialization](./storage-persistence-and-materialization.pack.md)
...
Use `relatedDocRecordIds` when you want stable-key links to documentation registry entries in addition to path references.
