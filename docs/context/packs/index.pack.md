...
- Keep runtime readiness as transport-neutral shared vocabulary for host-owned capability availability; do not conflate it with task registry lifecycle, installer status, supervisor internals, or UI/API/IPC payload design.
