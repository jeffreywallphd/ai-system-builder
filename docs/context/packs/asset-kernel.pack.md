...
- Durable resource-backed mapping registration, seeding, registry read facades, resource-backed scans/views, API/IPC/preload/UI exposure, and runtime behavior remain deferred.
