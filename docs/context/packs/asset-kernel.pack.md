...
- Durable resource-backed mapping registration, production built-in seed catalogs, host startup seeding execution, registry read facades, resource-backed scans/views, API/IPC/preload/UI exposure, and runtime behavior remain deferred.
