---
title: Documentation Index View
doc_type: ai-context
status: active
...
# Documentation Index View (Story 6.3.1)
...
- Registry guidance: `./documentation-registry.md`
...
- [API and Transport Surfaces Domain Overview](../architecture/domains/api-and-transport-surfaces/overview.md) (`doc-architecture-domain-api-and-transport-surfaces-overview`)
- [Core Platform and Composition Domain Overview](../architecture/domains/core-platform-and-composition/overview.md) (`doc-architecture-domain-core-platform-and-composition-overview`)
...
- [Execution Control Plane and Scheduling Domain Overview](../architecture/domains/execution-control-plane-and-scheduling/overview.md) (`doc-architecture-domain-execution-control-plane-and-scheduling-overview`)
...
- [Workspace Storage and Assets Domain Overview](../architecture/domains/workspace-storage-and-assets/overview.md) (`doc-architecture-domain-workspace-storage-and-assets-overview`)

### `architecture-reference` (12)
- [Architecture Document Scope Boundaries](../architecture/architecture-document-scope-boundaries.md) (`doc-architecture-document-scope-boundaries`)
- [Architecture Domain Cross-Linking Rules](../architecture/architecture-domain-cross-linking-rules.md) (`doc-architecture-domain-cross-linking-rules`)
- [Architecture Domain Migration Inventory](../architecture/architecture-domain-migration-inventory.md) (`doc-architecture-domain-migration-inventory`)
- [Architecture Domain Taxonomy](../architecture/architecture-domain-taxonomy.md) (`doc-architecture-domain-taxonomy`)
- [Architecture Domainization Rollout Boundaries and Follow-On Work](../architecture/architecture-domainization-rollout-boundaries.md) (`doc-architecture-domainization-rollout-boundaries`)
- [Architecture Migration Sequence and Priority Order](../architecture/architecture-migration-sequence-and-priority.md) (`doc-architecture-migration-sequence-and-priority`)
- [Architecture Supersession and Retirement Governance](../architecture/architecture-supersession-and-retirement-governance.md) (`doc-architecture-supersession-and-retirement-governance`)
...
- [Presentation and State (Legacy Link Stub)](../architecture/presentation-and-state.md) (`doc-architecture-superseded-presentation-and-state`)
...
- [Documentation Quality Exceptions and Escape Hatches Guide](../contributors/documentation-quality-exceptions-and-escape-hatches-guide.md) (`doc-contributors-documentation-quality-exceptions-and-escape-hatches-guide`)
- [Documentation Quality Monitoring and Feedback Guide](../contributors/documentation-quality-monitoring-and-feedback-guide.md) (`doc-contributors-documentation-quality-monitoring-and-feedback-guide`)
- [Documentation Quality Rollout Boundaries and Follow-On Opportunities Guide](../contributors/documentation-quality-rollout-boundaries-and-follow-on-opportunities-guide.md) (`doc-contributors-documentation-quality-rollout-boundaries-and-follow-on-opportunities-guide`)
- [Documentation Quality Rule Evolution Guide](../contributors/documentation-quality-rule-evolution-guide.md) (`doc-contributors-documentation-quality-rule-evolution-guide`)
- [Documentation Quality Tooling Maintenance Guide](../contributors/documentation-quality-tooling-maintenance-guide.md) (`doc-contributors-documentation-quality-tooling-maintenance-guide`)
...
- [Storage Administration Operations](../storage-administration-operations.md) (`doc-operations-storage-administration`)
- [Workspace Administration Operations](../workspace-administration-operations.md) (`doc-operations-workspace-administration`)
...
- [ADR-006 Policy-Aware Scheduling and Controlled Execution](../adr/records/adr-006-policy-aware-scheduling-and-controlled-execution.md) (`doc-adr-006-policy-aware-scheduling-and-controlled-execution`)

### `baseline` (3)
- [Documentation Migration Baseline](../documentation-migration-baseline.md) (`doc-baseline-documentation-migration-baseline`)
...
- [Context System Foundations Pack](./packs/context-system-foundations.pack.md) (`doc-context-pack-context-system-foundations`)
...
- [Observability and Readiness Context Pack](./packs/observability-and-readiness.pack.md) (`doc-context-pack-observability-and-readiness`)
...
- [Startup and Host Promotion Context Pack](./packs/startup-and-host-promotion.pack.md) (`doc-context-pack-startup-and-host-promotion`)
- [Storage, Persistence, and Materialization Context Pack](./packs/storage-persistence-and-materialization.pack.md) (`doc-context-pack-storage-persistence-and-materialization`)
...
- [Transport and Runtime Availability Context Pack](./packs/transport-and-runtime-availability.pack.md) (`doc-context-pack-transport-and-runtime-availability`)
