...
Use `docs/context/governance/documentation-segmentation-rollout-boundaries.md` to confirm initial segmentation completion boundaries, current non-goals, and approved follow-on extension paths.
