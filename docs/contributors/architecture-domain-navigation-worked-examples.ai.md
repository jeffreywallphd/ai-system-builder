---
title: "AI Companion: Architecture Domain Navigation Worked Examples"
...
# AI Companion: Architecture Domain Navigation Worked Examples
...
5. `docs/adr/records/adr-006-policy-aware-scheduling-and-controlled-execution.ai.md`
...
6. `docs/adr/records/adr-004-studios-as-views-over-shared-system-and-asset-model.ai.md`
...
6. `docs/adr/records/adr-005-trust-identity-and-security-boundary-enforcement.ai.md`
...
Primary domain route:
1. `docs/architecture/architecture-domain-taxonomy.ai.md`
2. `docs/architecture/architecture-document-scope-boundaries.ai.md`
3. `docs/architecture/architecture-domain-cross-linking-rules.ai.md`
4. `docs/architecture/domains/README.ai.md`
5. `docs/contributors/docs-placement-guide.ai.md`
6. `docs/contributors/architecture-domain-overview-reference-readability-guide.ai.md`
...
1. architecture router -> `docs/architecture/README.ai.md`
...
- `docs/contributors/architecture-domain-overview-reference-readability-guide.ai.md`
