...
- Use `docs/context/documentation-segmentation-seed-guidance.md` when you need a quick copy/paste classification note, supersession marker, baseline introduction, or migration decision checklist.
