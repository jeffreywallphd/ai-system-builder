...
- Feature 16 / Epic 16.3 Story 16.3.3 operational run/queue projection reads for queue position, action eligibility, status history, and user-safe failure summaries: `docs/architecture/run-orchestration-operational-visibility-projections.md`
...
- Feature 16 / Epic 16.2 Story 16.2.8 contributor workflow for scheduler-policy, assignment, dispatch, execution-update, and finalization extensions: `docs/run-orchestration-contributor-guide.md`
