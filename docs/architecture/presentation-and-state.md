...
- Migration audit snapshot for workflow authoring/runtime seams under the studio-shell flow:
  ...
  - **Legacy compatibility infrastructure:** `ExperienceAssetAuthoringBoundary` remains active for Dataset/System studios but remains disconnected from Workflow Studio runtime.
