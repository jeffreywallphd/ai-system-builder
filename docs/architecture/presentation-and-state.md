...
- Wizard Steps now also include an integrated agent/assistant asset selector sourced from registry taxonomy filters (`composite/agent/autonomous`) with per-step select/replace/clear behavior and a visible create-in-context handoff placeholder CTA.
