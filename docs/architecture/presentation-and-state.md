...
- Wizard sections are read-only state projections in this slice and are bound directly to canonical shared draft arrays with explicit empty-state rendering for each section.
