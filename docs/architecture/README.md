...
- For operational run/queue read-model projections (queue position, action eligibility, status history, and user-safe failure summaries), read [`run-orchestration-operational-visibility-projections.md`](./run-orchestration-operational-visibility-projections.md).
