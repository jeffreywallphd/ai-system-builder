...
- For scheduler-authoritative queue lease selection, policy-evaluated assignment materialization, and preserved claim/dispatch invariants in queue processing flow, read [`run-orchestration-scheduling-authoritative-queue-selection-and-assignment-integration.md`](./run-orchestration-scheduling-authoritative-queue-selection-and-assignment-integration.md).
...
- For contributor workflow when extending scheduler policy, assignment logic, dispatch adapters, progress ingestion, and finalization behavior, read [`../run-orchestration-contributor-guide.md`](../run-orchestration-contributor-guide.md).
