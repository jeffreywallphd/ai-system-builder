...
For full inbound/outbound cross-linking rules across ADRs, context packs, baselines, contributor docs, and operations docs, use [Architecture Domain Cross-Linking Rules](../architecture-domain-cross-linking-rules.md).
