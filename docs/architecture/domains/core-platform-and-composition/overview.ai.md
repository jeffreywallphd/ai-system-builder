...
Define the architecture boundary for core-platform-and-composition and route future migration of flat architecture references into this domain.

## Boundary

- Owns architecture contracts scoped to the core-platform-and-composition domain taxonomy boundary.
