...
- Still intentionally out of scope in renderer: full dedicated system canvas/editor UX and system-specific runtime orchestration UIs beyond shared shell metadata/dependency/lifecycle/publish flows.
