...
- Invalid workflow mode routes are handled as safe fallbacks (mode preserved, warning surfaced) so unsupported mode URLs do not break draft authoring or shared save/lifecycle flows.
