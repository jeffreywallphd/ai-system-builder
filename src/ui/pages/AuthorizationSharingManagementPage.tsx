...
export default function AuthorizationSharingManagementPage(props: AuthorizationSharingManagementPageProps = {}): JSX.Element {
  ...
  const thinClientPath = buildAuthorizationSharingThinClientPath({
    resourceFamily,
    resourceType,
    resourceId,
  ...
  if (!sessionToken || !session || sessionStore.isSessionExpired(session)) {
    return (
      <section className="ui-page ui-authorization-management-page">
        <div className="ui-card">
          <div className="ui-card__header">
            <h1 className="ui-card__title">Resource sharing and visibility</h1>
            <p className="ui-card__subtitle">
              Sign in with an authenticated account before reviewing or updating sharing access.
            </p>
          </div>
    ...
    <section className="ui-page ui-authorization-management-page">
      <div className="ui-page__hero">
        <div className="ui-page__hero-copy">
          <h1 className="ui-page__title">Resource sharing and visibility</h1>
          <p className="ui-page__subtitle">
            Manage who can access a protected resource. Use this desktop surface for complete visibility and sharing operations.
          </p>
        </div>
        <div className="ui-page__actions">
          <Link className="ui-button ui-button--secondary ui-button--sm" to={ROUTE_PATHS.settings}>Back to settings</Link>
          <Link className="ui-button ui-button--secondary ui-button--sm" to={thinClientPath}>Open compact web view</Link>
        </div>
      </div>
