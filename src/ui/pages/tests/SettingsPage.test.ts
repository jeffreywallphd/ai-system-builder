...
describe("SettingsPage", () => {
  ...
  it("includes workspace mode controls and contextual advanced areas", () => {
    ...
    expect(source).toContain("listSettingsShortcutRouteMetadata");
    expect(source).toContain("UiSurfaceKeys.desktopAdmin");
    expect(source).toContain("settingsShortcutRoutes.map");
