            ...
            <div className="ui-stack ui-stack--2xs" data-testid={`workflow-output-config-${selectedOutputIndex}`}>
              {(selectedDefinition?.configurationFields ?? []).map((field) => {
                ...
                const testIdByFieldKey: Record<string, string> = Object.freeze({
                  ...
                  recordCollection: `workflow-output-system-record-collection-${selectedOutputIndex}`,
                  writeMode: `workflow-output-system-write-mode-${selectedOutputIndex}`,
                  recordShape: `workflow-output-system-record-shape-${selectedOutputIndex}`,
                  includeExecutionMetadata: `workflow-output-system-include-metadata-${selectedOutputIndex}`,
                  destinationConfig: `workflow-output-system-record-collection-${selectedOutputIndex}`,
