...
function createStubClient(overrides: {
  ...
  const client: IdentityAuthClient = {
    ...
    listIdentitySessions: async (_request: ListIdentitySessionsApiRequest, _sessionToken: string): Promise<IdentityAuthApiResponse<ListIdentitySessionsApiResponse>> => ({ ok: false, error: { code: "internal", message: "not implemented" } }),
    ...
    listIdentityAdminSessions: async (_request: ListIdentityAdminSessionsApiRequest, _sessionToken: string): Promise<IdentityAuthApiResponse<ListIdentityAdminSessionsApiResponse>> => ({ ok: false, error: { code: "internal", message: "not implemented" } }),
    revokeIdentityAdminSession: async (_request: RevokeIdentityAdminSessionApiRequest, _sessionToken: string): Promise<IdentityAuthApiResponse<RevokeIdentityAdminSessionApiResponse>> => ({ ok: false, error: { code: "internal", message: "not implemented" } }),
