...
import { toGeneratedResultLineageDetailDto } from "./GeneratedResultLineageProjection";
import {
...
export interface GetGeneratedResultLineageDetailUseCaseDependencies {
...
export class GetGeneratedResultLineageDetailUseCase implements IGetGeneratedResultLineageDetailUseCase {
  private readonly clock: { now(): Date };

  public constructor(
    private readonly dependencies: GetGeneratedResultLineageDetailUseCaseDependencies,
  ) {
  ...
  public async execute(
    ...
    try {
      ...
      return this.failure(
        ...
        error instanceof Error ? error.message : "Invalid generated-result lineage detail request.",
      );
    }
    ...
    if (!workspaceAuthorization.isAuthorized) {
      return this.failure(
        ...
        "Generated-result lineage detail lookup requires active workspace membership.",
      );
    }
    ...
    return {
      ok: true,
      value: Object.freeze({
        lineage: toGeneratedResultLineageDetailDto({
          record,
          lineage,
        }),
      }),
