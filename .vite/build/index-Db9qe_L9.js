...
function patchWebByobTokenizerClose(tokenizer) {
  ...
  if (((_a = streamReader == null ? void 0 : streamReader.constructor) == null ? void 0 : _a.name) !== "WebStreamByobReader") {
    return tokenizer;
  }
...
let FileTypeParser$1 = class FileTypeParser {
  ...
  async fromBlob(blob) {
    var _a;
    (_a = this.options.signal) == null ? void 0 : _a.throwIfAborted();
  ...
  async detectGzip(tokenizer) {
    ...
    try {
      ...
      if ((error == null ? void 0 : error.name) === "AbortError" && ((_a = probeSignal == null ? void 0 : probeSignal.reason) == null ? void 0 : _a.name) !== "TimeoutError") {
        throw error;
      }
    } finally {
...
class FileTypeParser2 extends FileTypeParser$1 {
  async fromStream(stream) {
    var _a;
    (_a = this.options.signal) == null ? void 0 : _a.throwIfAborted();
...
export {
  FileTypeParser2 as FileTypeParser,
  fileTypeFromBlob,
  fileTypeFromBuffer,
  fileTypeFromFile,
  fileTypeFromStream,
